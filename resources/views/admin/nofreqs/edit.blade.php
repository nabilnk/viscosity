...
@section('content')
  <div class="container mx-auto p-6">
        ...
        <form method="POST" action="{{ route('admin.nofreqs.update', $nofreq->id) }}" class="space-y-6">
            ...
            <div>
                <label class="block mb-1 text-gray-200">Title</label>
           ...
           <iframe width="560" height="315" src="https://www.youtube.com/embed/tgbNymZ7PTg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </form>
    </div>
@endsection