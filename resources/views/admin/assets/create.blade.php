...
<div class="container mx-auto px-6 py-8">
    <div class="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700" x-data="{ type: 'track_record' }">
        <h1 class="text-2xl font-bold text-white mb-6">Tambah Aset Baru</h1>
        <form method="POST" action="{{ route('admin.assets.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select id="type" name="type" x-model="type" class="mt-1 block w-full py-2 px-3 border border-gray-600 bg-gray-700 text-white rounded-md shadow-sm" required>
                    <option value="track_record">Track Record Activity</option>
            ...
            <!-- Gambar -->
            <div class="mb-4">
                <label for="image" class="block font-medium text-sm text-gray-300">File Gambar</label>
                <input id="image" name="image" type="file" class="mt-1 block w-full text-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700" required>
            ...
            <div x-show="type === 'team'" x-transition class="border-t border-gray-700 pt-4 mt-4">
                ...
                <div class="mb-4">
                    ...
                    <input id="name" name="name" type="text" class="mt-1 block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm">
                </div>
                <div class="mb-4">
                    <label for="position" class="block font-medium text-sm text-gray-300">Jabatan</label>
                    <input id="position" name="position" type="text" class="mt-1 block w-full bg-gray-700 border-gray-600 text-white rounded-md shadow-sm">
                </div>
            </div>
