                ...
                <div class="hidden sm:flex sm:items-center sm:ml-auto">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <div x-data="{ open: false }" @mouseleave="open = false" class="relative">
                            <button @mouseover="open = true" class="flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('event.*') ? 'text-purple-400' : 'text-gray-400 hover:text-white' }}">
                                <span>EVENT</span>
                            ...
                            <div x-show="open" x-transition class="absolute z-10 w-48 rounded-md shadow-lg bg-zinc-800 border border-zinc-700 ring-1 ring-black ring-opacity-5" style="display: none;">
                                <div class="py-1">
                                ...
                                <x-slot name="content">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <x-dropdown-link :href="route('logout')"
                                                ...
                                                class="!text-red-500 hover:!bg-red-900/50">
                                            {{ __('Log Out') }}
                                        </x-dropdown-link>
                                    </form>
                                </x-slot>
