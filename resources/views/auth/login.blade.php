<x-guest-layout>
    <div class="relative flex items-center justify-center min-h-screen overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-xs p-2">
            ...
            {{-- Login Title --}}
            <h2 class="text-center text-white text-2xl font-semibold uppercase mb-8 tracking-widest">LOGIN</h2>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <label
                        for="password"
                        class="absolute left-0 -top-3.5 text-gray-300 text-sm font-bold peer-placeholder-shown:text-base peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-white peer-focus:text-sm"
                    >
                        Password
                    </label>
                    {{-- Icon Mata di kanan --}}
                    ...
                    @if (Route::has('password.request'))
                        <div class="text-right mt-2">
                            <a href="{{ route('password.request') }}" class="text-xs text-gray-100 hover:text-purple-400">
                                Forgot Password?
                            </a>
                        </div>
                    @endif
                ...
                <div class="text-center mt-4 text-sm text-white">
                    Belum Punya Akun?
                    <a href="{{ route('register') }}" class="underline hover:text-purple-400">
                        Daftar Disini!
                    </a>
                </div>
            </form>
